...
def traffic_astar(env, start, goal, stops):
    ...
    return best_order, best_dist, full_path, num_nodes, score
...
def main():
    ...
    # Copy and paste the best list of stops from the local search output
